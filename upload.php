...
define ("WIDTH","300"); //set here the width you want your thumbnail to be
define ("HEIGHT","300"); //set here the height you want your thumbnail to be.
define ("WIDTH2","300"); //set here the width you want your thumbnail to be
define ("HEIGHT2","300"); //set here the height you want your thumbnail to be.
